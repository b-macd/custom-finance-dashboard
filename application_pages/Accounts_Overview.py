...
st.title("Fixed and Variable Accounts Overview")

if st.session_state.dataframes == {}:
    st.info("No data found. Please load your data first from the Home Page.")
else:
    if len(list(st.session_state.dataframes.keys())) < 2:
        st.error("Please upload at least two CSV files to compare fixed and variable accounts.")
    else:
